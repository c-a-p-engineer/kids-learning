...
8. 🖍️ えんぴつれんしゅう — 線や形をなぞって手を動かす
9. ✏️ かきとりマスター — 文字や記号を書く

ゲーム形式のコンテンツには終了条件を設けます。反復クイズ型ゲームは時間で、書字・運筆型課題と100そろばんの問題モードは確定した問題数で区切ります。時間制限なしの無限継続モードは設けません。
