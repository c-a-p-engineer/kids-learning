...
トップ画面は、上から順番に進めることで、視覚認識から書字へ段階的に進める構成です。複数列表示でもSTEP 1から横方向へ順番に並びます。

1. 🧩 ぴったりシェイプ — 同じ形を見つける
2. 🧠 えもじフラッシュ — 見たものを覚える
3. 🟡 ドットバースト — 数量をまとまりで捉える
4. 🧮 100そろばん — 10のまとまりと100までの数を操作する
...
反復クイズや運筆チャレンジには時間または問題数の区切りを設けます。100そろばんは、問題モードを10問で区切り、自由操作モードは時間制限なしで利用者が「おわる」を選ぶまで続けられます。
...
| 4 | 100そろばん | 0〜100、5・10のまとまり、十の位・一の位 | 左は未カウント、右はカウント、操作音、数をそろえる10問、時間制限なしの自由操作、履歴 |
