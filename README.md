...
ゲーム形式のコンテンツには終了条件を設けます。反復クイズ型ゲームとえんぴつれんしゅうは時間で、100そろばんの問題モードと書字課題は確定した問題数で区切ります。時間制限なしの無限継続モードは設けません。
...
| 4 | 100そろばん | 0〜100、5・10のまとまり、十の位・一の位 | 左は未カウント、右はカウント、5個・10個単位の配色、操作音、問題10問、自由操作3分、履歴 |
